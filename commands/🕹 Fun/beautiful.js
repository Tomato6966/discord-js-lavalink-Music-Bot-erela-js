...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
        ...
        let fastembed2 = new Discord.MessageEmbed().setColor(ee.color).setFooter(ee.footertext, ee.footericon).setImage("attachment://beautiful.png").attachFiles(attachment);
