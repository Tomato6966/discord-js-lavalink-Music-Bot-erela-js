    ...
    try{
      ...
      if (message.member.guild.owner.id !== message.author.id)
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle("❌ Error | You don\'t have permission for this Command! *Only the Server-Owner*")
        );
      //ask for second yes
        ...
        .then(async collected => {
          ...
          if(collected.first().content.toLowerCase() === "yes")
          {
            ...
            return message.channel.send(new MessageEmbed()
              .setColor(ee.color)
              .setFooter(ee.footertext, ee.footericon)
              .setTitle(`✅ Success | Resetted everything!`)
          ...
          return message.channel.send(new MessageEmbed()
            .setColor(ee.wrongcolor)
            .setFooter(ee.footertext, ee.footericon)
            .setTitle("❌ Error | CANCELLED CAUSE NOT THE RIGHT WORD / TIME RAN OUT!")
          );
        })
      });
    } catch (e) {
